...
export default function Footer() {
  return <footer className="footer"><div className="wrap foot-in">
    ...
    <div className="foot-column"><strong>Learn</strong><Link to="/why-microgreens">What are microgreens?</Link><Link to="/our-process">How we grow</Link><Link to="/how-to-use">How to eat them</Link><Link to="/about">Why microgreens</Link></div>
