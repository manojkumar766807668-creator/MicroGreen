...
export default function Footer() {
  ...
  return <footer className="footer"><div className="wrap foot-in">
    ...
    <div className="foot-column"><strong>{t("Company help")}</strong><Link to="/about">{t("About us")}</Link><Link to="/farm-visits">{t("Farm visits")}</Link><Link to="/contact">{t("Contact")}</Link><Link to="/contact#faq">{t("FAQs")}</Link></div>
