...
export default function FarmVisits() {
  ...
  return <><PageHero title="Step inside the farm." /><FarmBand />
    ...
    <section className="sec cream"><div className="wrap narrow"><Heading title="Plan Your Visit">Tell us your preferred date, visit type, number of people, and any additional notes. We'll receive your request through WhatsApp and help you plan your visit.</Heading><FarmVisitForm /></div></section></>;
}
